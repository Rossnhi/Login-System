while True:
	...
	if a == "signup" or a == "sign up":
		s = "{"
		file = open("/Users/roshni/Python projects/Database/login_system_data.txt")
		name = input("Enter your name\n")
		if file.read() != "":
			file.seek(0) #go back to starting position and read from there again next time. If this code is not written next time when the file is read it will return an empty string.
			s = file.read()
			dataDict = eval(s)
